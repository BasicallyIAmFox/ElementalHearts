...
{
    public class MenacingHeartRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "ElementalHearts/Tiles/MenacingHeartRelic";

		public override string Texture => "ElementalHearts/Tiles/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Placeables.MenacingHeartRelic>();
					break;
			}
